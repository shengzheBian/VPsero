...
ERROR|  Blastn is error|Make sure `blastall`,`formatdb`,`s12_mkdb_blastn.py` three files all in `scripts_of` directory, and you have changed the mode of `scripts_of/blastall` and `scripts_of/formatdb` according to the installation section.
